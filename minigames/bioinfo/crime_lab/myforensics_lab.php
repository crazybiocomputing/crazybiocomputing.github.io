...
<div id="page">
<div id="content">
<p style="font-family: 'Walter Turncoat', cursive;font-size:30px">C&nbsp;h&nbsp;a&nbsp;p&nbsp;t&nbsp;e&nbsp;r&nbsp;&nbsp;&nbsp;2: Back to the crazyBio Lab....</p>
...
if (isset($_POST['OK']) ) {
  ...
  $id44=trim(strtoupper($_POST['a4']));
  $id55=trim(strtoupper($_POST['a5']));
  ...
  if ($score==31)   
    echo '<span style="font-size:24px"><a title="Click on \'yes\'" style="text-decoration:none" href="sugar.php">Yeeess!!!</a></span></p>';
  else
...
?>
<div id="popup">
<p style="font-family: 'Walter Turncoat'">During a coffee break</p>
