...
function configLinkButton(elt, path, backcolor) {
...
function configOneButton() {
    ...
    configLinkButton(elt,button.dataset.path,"#0078e7");
}
...
function highlight() {
    let strings = document.querySelectorAll('.hljs-string,.hljs-value');
